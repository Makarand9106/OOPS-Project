...
public class AdminDashboard extends JPanel {
    ...
    private JPanel buildAddUserPanel() {
        ...
        // Department dropdown
        JComboBox<String> deptCombo = new JComboBox<>(getAllDepartments().toArray(new String[0]));
        styleCombo(deptCombo);
        deptCombo.setPreferredSize(new Dimension(200, 34));
        ...
        addFormRow(form, gc, 3, "Department:", deptCombo);
        ...
        addBtn.addActionListener(e -> {
            ...
            if (ok) {
                ...
                nameField.setText(""); deptCombo.setSelectedIndex(0);
            } else {
                JOptionPane.showMessageDialog(frame,
    ...
    /** Get all unique departments from existing users. */
